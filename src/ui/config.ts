...
- Explicitly return what you want to see; returned Figma nodes are serialized to {id, name, type} with position, size, fill color, text content, and child count when available.
